...
#define INCAPACITATION_DISABLED (INCAPACITATION_KNOCKOUT|INCAPACITATION_STUNNED)
...
#define SLOWDOWN_REMOVAL_CHEM_MAX_REMOVED 2
#define SPEEDBOOST_CHEM_SPEED_INCREASE 1
...
#define THIRST_LEVEL_MAX 400
#define THIRST_LEVEL_FILLED 300
#define THIRST_LEVEL_MEDIUM 200
#define THIRST_LEVEL_THIRSTY 175
...
#define PAIN_SCREAM_CHANCE 70
#define SUPRESSION_SCREAM_CHANCE 5
#define SCREAM_COOLDOWN 0.5 SECONDS

//Hunger levels for humans
#define HUNGER_SATED 450
#define HUNGER_HUNGRY 250
#define HUNGER_STARVING 100
