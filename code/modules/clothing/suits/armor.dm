...
/obj/item/clothing/suit/armor/special/wwi/britarmor
	...
	desc = "A bulky suit of well worn diesel powered armor given to frontline troops. It has a special mechanism for latching onto the Lewis, as well as a compartment for storing two .303 drums internally."
	w_class = ITEM_SIZE_HUGE
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS
	armor = list(melee = 25, bullet = 35, laser = 0, energy = 0, bomb = 10, bio = 5, rad = 0)
	cold_protection = UPPER_TORSO|LOWER_TORSO|LEGS|ARMS
