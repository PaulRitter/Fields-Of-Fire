/datum/hud_data
	...
	var/list/gear = list(
		"i_clothing" =   list("loc" = ui_iclothing, "name" = "Uniform",      "slot" = slot_w_uniform, "state" = "center"),
		...
		"ears"  =        list("loc" = ui_ears,      "name" = "Ears"    ,     "slot" = slot_ears,      "state" = "ears",   "toggle" = 1),
		...
		"id" =           list("loc" = ui_id,        "name" = "ID",           "slot" = slot_wear_id,   "state" = "id",     "toggle" = 1),
		"storage1" =     list("loc" = ui_storage1,  "name" = "Left Pocket",  "slot" = slot_l_store,   "state" = "pocket"),
		"storage2" =     list("loc" = ui_storage2,  "name" = "Right Pocket", "slot" = slot_r_store,   "state" = "pocket"),
		"belt" =         list("loc" = ui_belt,      "name" = "Belt",         "slot" = slot_belt,      "state" = "belt"),
		"sling" =        list("loc" = ui_sling,     "name" = "Sling",        "slot" = slot_sling,     "state" = "back2"),
		)
...
/datum/hud_data/diona
	...
	gear = list(
		...
		"ears" =         list("loc" = ui_gloves,    "name" = "Ear",          "slot" = slot_ears,     "state" = "ears",   "toggle" = 1),
...
/datum/hud_data/nabber
	...
	gear = list(
		"i_clothing" =   list("loc" = ui_iclothing, "name" = "Uniform",      "slot" = slot_w_uniform, "state" = "center", "toggle" = 1),
		"o_clothing" =   list("loc" = ui_shoes,     "name" = "Suit",         "slot" = slot_wear_suit, "state" = "suit",   "toggle" = 1),
		"ears" =         list("loc" = ui_oclothing, "name" = "Ear",          "slot" = slot_ears,     "state" = "ears",   "toggle" = 1),
		"gloves" =       list("loc" = ui_gloves,    "name" = "Gloves",       "slot" = slot_gloves,    "state" = "gloves", "toggle" = 1),
		"suit storage" = list("loc" = ui_sstore1,   "name" = "Suit Storage", "slot" = slot_s_store,   "state" = "suitstore"),
		"back" =         list("loc" = ui_back,      "name" = "Back",         "slot" = slot_back,      "state" = "back"),
		"id" =           list("loc" = ui_id,        "name" = "ID",           "slot" = slot_wear_id,   "state" = "id"),
