...
/mob/living/carbon/proc/print_thirst(var/mob/user)
	switch(thirst)
		if(THIRST_LEVEL_THIRSTY to INFINITY)
			to_chat(user, "<span class = 'notice'>I'm feeling hydrated!</span>")
		if(THIRST_LEVEL_DEHYDRATED to THIRST_LEVEL_THIRSTY)
			to_chat(user, "I'm feeling a little thirsty.")
		if(0 to THIRST_LEVEL_DEHYDRATED)
			to_chat(user, "<span class = 'warning'>[pick("I'm parched!","I'm feeling dehydrated!","So...thirsty...")]</span>")
